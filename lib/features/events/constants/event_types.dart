// lib/features/events/constants/event_Types.dart
import 'package:flutter/material.dart';

class EventTypes {
  // ✅ SINGLE SOURCE OF TRUTH - Modify only here to update everywhere
  
  // Available event Types - ADD/REMOVE/MODIFY ONLY HERE
  ...
  // ✅ Centralized display nnames - ADD NEW CASES HERE FOR NEW TYPES
  ...
  static String getDescription(String type) {
    switch (type) {
      case general: return 'General purpose event';
      ...
      case other: return 'Other type of event';
      default: return 'General purpose event';
    }
  }

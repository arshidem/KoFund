// lib/core/skeleton/all_event_skeleton.dart
import 'package:flutter/material.dart';
import 'package:shimmer/shimmer.dart';
import 'package:kofund/core/constants/app_colors.dart';

class AllEventsSkeleton extends StatelessWidget {
  final bool isDarkMode;

  const AllEventsSkeleton({super.key, required this.isDarkMode});
  ...
  static Widget _buildShimmerItem(BuildContext context, bool isDarkMode) {
    ...
    return Shimmer.fromColors(
      ...
      child: _builCardSkeleton(context),
    );
  }

  static Widget _builCardSkeleton(BuildContext context) {
    return Container(
